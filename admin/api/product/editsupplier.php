...
if (empty($data['id']) || empty($data['name']) || empty($data['tax']) || empty($data['contact_name']) || empty($data['phone']) || empty($data['email'])) {
...
try {
    ...
    $result = $db->updateSupplier($id, $name, $tax, $contact_name, $phone, $email);
    if ($result) {
